...
/// <summary>
///     Wrapper around ConcurrentDictionary that ensures GetOrAdd only invokes the valueFactory once for a given key by
///     using locks.
/// </summary>
	...
	where TKey : notnull
{
	...
	/// <summary>
	///     Adds a key/value pair to the Dictionary by using the specified function if the key does not already exist. This is
	///     done inside a lock.
