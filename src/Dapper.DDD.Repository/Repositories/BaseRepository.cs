...
{
	protected BaseRepository(BaseAggregateConfiguration<TAggregate> configuration,
		DefaultConfiguration? defaultConfiguration) : base(configuration, defaultConfiguration)
	{
	...
	private void AddWrappedValue(IDictionary<string, object?> dictionary, ExtendedPropertyInfo property,
		object? value)
	{
		if (value is null)
		{
	...
	where TAggregate : notnull
{
		...
		DefaultConfiguration? defaultConfiguration)
	{
		...
		ObjectFlattener.SetTypeProperties(typeof(TAggregate),
			((IReadAggregateConfiguration<TAggregate>)configuration).GetProperties());
	...
	protected async Task<IEnumerable<TAggregate>> QueryAsync(string query, object? param = null,
		...
		CancellationToken cancellationToken = default)
	{
		...
		try
		{
			if (_shouldFlattenAggregate)
			{
				...
				var result = await _dapperInjection.QueryAsync(connection, flatType, query,
			...
			return await _dapperInjection.QueryAsync(connection, query, _objectFlattener.Flatten(param),
				transaction, commandTimeout, commandType, cancellationToken);
		}
		catch (Exception ex)
		{
	...
	protected async Task<TAggregate?> QuerySingleOrDefaultAsync(string query, object? param = null,
		IDbTransaction? transaction = null, int? commandTimeout = null, CommandType? commandType = null,
		CancellationToken cancellationToken = default)
	{
		using var connection = _connectionFactory.CreateConnection();
		try
		{
			...
			{
				var flatType = _objectFlattener.GetFlattenedType<TAggregate>();
				var result = await _dapperInjection.QuerySingleOrDefaultAsync(connection, flatType, query,
					_objectFlattener.Flatten(param), transaction, commandTimeout, commandType, cancellationToken);
				return result is not null ? _objectFlattener.Unflatten<TAggregate>(result) : default;
			}

			return await _dapperInjection.QuerySingleOrDefaultAsync(connection, query,
				_objectFlattener.Flatten(param), transaction, commandTimeout, commandType, cancellationToken);
		}
		catch (Exception ex)
		{
	...
	protected async Task<TAggregate> QuerySingleAsync(string query, object? param = null,
		IDbTransaction? transaction = null, int? commandTimeout = null, CommandType? commandType = null,
		CancellationToken cancellationToken = default)
	{
		using var connection = _connectionFactory.CreateConnection();
		try
		{
			...
			{
				var flatType = _objectFlattener.GetFlattenedType<TAggregate>();
				var result = await _dapperInjection.QuerySingleAsync(connection, flatType, query,
					_objectFlattener.Flatten(param), transaction, commandTimeout, commandType, cancellationToken);
				return _objectFlattener.Unflatten<TAggregate>(result);
			}

			return await _dapperInjection.QuerySingleAsync(connection, query, _objectFlattener.Flatten(param),
				transaction, commandTimeout, commandType, cancellationToken);
		}
		catch (Exception ex)
		{
		...
		CancellationToken cancellationToken = default)
	{
		...
		try
		{
			...
			return await dapperInjection.QueryAsync(connection, query, _objectFlattener.Flatten(param), transaction,
				commandTimeout, commandType, cancellationToken);
		}
		catch (Exception ex)
		{
			throw new DapperRepositoryQueryException(query, ex);
		...
		CancellationToken cancellationToken = default)
	{
		...
		try
		{
			...
			var dapperInjection = _dapperInjectionFactory.Create<TResult>();
			return await dapperInjection.QuerySingleOrDefaultAsync(connection, query,
				_objectFlattener.Flatten(param), transaction, commandTimeout, commandType, cancellationToken);
		}
		catch (Exception ex)
		{
		...
		CancellationToken cancellationToken = default)
	{
		...
		try
		{
			...
			var dapperInjection = _dapperInjectionFactory.Create<TResult>();
			return await dapperInjection.QuerySingleAsync(connection, query, _objectFlattener.Flatten(param),
				transaction, commandTimeout, commandType, cancellationToken);
		}
		catch (Exception ex)
		{
	...
	protected async Task<int> ExecuteAsync(string query, object? param = null, IDbTransaction? transaction = null,
		int? commandTimeout = null, CommandType? commandType = null, CancellationToken cancellationToken = default)
	{
		using var connection = _connectionFactory.CreateConnection();
		try
		{
			return await _dapperInjection.ExecuteAsync(connection, query, _objectFlattener.Flatten(param),
				transaction, commandTimeout, commandType, cancellationToken);
		}
		catch (Exception ex)
		{
